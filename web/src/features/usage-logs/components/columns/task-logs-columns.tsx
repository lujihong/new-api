    ...
    <>
      <div className='flex max-w-[220px] flex-col items-start gap-1'>
        ...
        {props.log.fail_reason ? (
          <span className='inline-flex items-center gap-1 max-w-full truncate text-xs text-red-600 dark:text-red-400'>
            <AlertCircle className='size-3 text-red-500 shrink-0' />
            <span className='truncate'>{props.log.fail_reason}</span>
          </span>
        ) : null}
      </div>
      <TaskDetailsDialog
